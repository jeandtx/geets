        ...
        <div className='flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white'>
            <div className='wrapper pt-5 pb-3 px-7'>
                ...
                <div className='body space-y-5'>
                    ...
                    {post.media && <Img className='w-full h-64 object-cover rounded-xl' src={post.media} alt='Post media' width={1280} height={960} />}
                </div>
                ...
                <div className='footer space-y-3'>
                    <div className='icon-group flex justify-between items-center '>
                        ...
                        >
                            ...
                            <span className='hidden sm:block text-gray-600 font-semibold text-sm'>J&apos;aime</span>
                        </Button>
                        <Button
                            variant={'outline'}
                            className='border-0 flex space-x-3 px-5 py-3 rounded-xl cursor-pointer duration-200 transition-all hover:bg-slate-100 active:transform active:scale-95 select-none'
                        ...
                        >
                            ...
                            <span className='hidden sm:block text-gray-600 font-semibold text-sm'>Commenter</span>
                        </Button>
                        <Link
                        ...
                        >
                            ...
                            <span className='hidden sm:block text-gray-600 font-semibold text-sm'>Visiter</span>
                        </Link>
                    </div>
                </div>
            </div>

...
export default function ProjectDetails({
	...
	// the participant that is role: author
	const profileId =
		project.participants?.find((p) => p.role === "author")?.name ?? "error";
					...
					<div className="flex flex-col">
						...
						<div>
							{session?.user?.email ===
								...
								<Link
									href={`/${profileId}/${project._id}/settings`}
								>
									<Button variant="link">Paramètres</Button>
								</Link>
							)}
						</div>

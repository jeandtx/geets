...
export default function SettingsPage({
	...
	const author = participants.find((p) => p.role === "author")?.name;
	if (userInfo?.email !== author) {
		return (
						...
						<div className="inline-flex justify-between">
							...
							<TooltipProvider>
								<Tooltip>
									...
									<TooltipContent>
										<div>
											Renseigne les compétences
											spécifiques que tu recherches pour
											donner vie à ton projet !
										</div>
									</TooltipContent>
								</Tooltip>
							</TooltipProvider>
							...
							<AlertDialogContent>
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										...
										Cette option va supprimer définitivement
										le projet et toutes les données
										associées.
									</AlertDialogDescription>
								</AlertDialogHeader>
								<AlertDialogFooter>
